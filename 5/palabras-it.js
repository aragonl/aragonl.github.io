...
export const WORD_DATA = [
    ...
    words: [
      {
        ...
        help: ["dare da mangiare", "dare da bere", "vestire gli ignudi", "dare un tetto"]
      },
      {
  ...
  {
    tags: ["Biblia", "Vangeli", "N.T.", "Storia"],
    ...
    words: [
      {
        ...
        words: ["PARISEI & SADDUCEI", "SCRIBI & PUBBLICANI", "ZELOTI & ERODIANI", "LEVITI & SACERDOTI"],
  ...
  {
    tags: ["Vangeli", "Storia", "Tradizione"],
    category: "Apostoli",
    dificultad: 2,
    fortext: "I 14 eletti",
    words: [
  ...
  },
  {
    ...
    help: [
      ...
      "«Lodate il nostro Dio» — Ap 19,5",
      "«Riposeranno dalle loro fatiche» — Ap 14,13"
    ]
  },
  {
  ...
  },
  {
    ...
    words: [
      ...
      },
      {
        ...
        help: [
          "«C'erano in quella regione alcuni pastori» — Lc 2,8",
          "«Apparve una moltitudine dell'esercito celeste» — Lc 2,13",
          "«Il bue conosce il suo proprietario» — Is 1,3",
          "«L'asino la greppia del suo padrone» — Is 1,3"
        ]
      }
    ]
  },
